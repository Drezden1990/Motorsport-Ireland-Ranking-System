...
<div class="container adminPage"> <!-- frame page -->
    ...
    <ul>
        ...
        <p class="userInput"><input  name="driver_id">
        ...
        ?>
           ...
           <form action="driverPortal.php" method="get">
                <input hidden type="text" name="Licence_No" value= <?php echo "\"". $_POST['driver_id']."\"";?> >
                <input class="submit" <?php if(!isset($_POST['driver_id']) or !$row1){echo "hidden";}?> type="submit" value="View Profile">
            </form>
        </div>
        </div>
