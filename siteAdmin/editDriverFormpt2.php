...
<div class="container adminPage"> <!-- frame page -->
    ...
    <ul>
        ...
        <div class="forms">
        <div class="formHead">
            <h2> UpdateDriver Info </h2>
        </div>
        <div class="mainForm"><!-- Form -->
            <form action="../phpScripts/updateDriver.php" method="post">
             <p class="detail">License Number:</p> <p class="userInput"> <?php echo $_GET['licence_no']; ?> </p><br>
             <p class="detail"> Name: </p> <p class="userInput"> <input type="text" name="Name" value= <?php echo "\"".$row['Name']."\""; ?> > </p><br><br>          
		...
		<option value="1">Registered</option>
            ...
            <p class="detail"> Standard:</p> <p class="userInput">  <select name ="standard">
                 ...
                 <p class="detail">Penalty Points:</p> <p class="userInput">  <input type="text" name="penalty_points" value= <?php echo "\"".$row['Penalty_Points']."\""; ?>></p><br><br>
                 <input hidden type="text" name="Licence_No" value= <?php echo "\"". $_GET['licence_no']."\"";?> >
